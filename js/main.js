...
main.prototype.createCharacter=function(){
	...
	//console.log(character.body.value.toString());
	console.log("w: "+character.width);
	console.log("h: "+character.height);
}
...
var tree = game.add.sprite(game.world.centerX*.1,game.world.centerY*.1,"Tree1");
